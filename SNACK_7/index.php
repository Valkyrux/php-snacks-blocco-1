...
$rand_ads_num = rand(0, sizeof($ads) - 1);
while ($ads[$rand_ads_num]["is_active"] === false) {
    $rand_ads_num = rand(0, (sizeof($ads) - 1));
}
?>
...
<body>
    <div class="card">
        <img src="<?php echo $ads[$rand_ads_num]["image_path"] ?>" alt="">
        <a href="<?php echo $ads[$rand_ads_num]["link"] ?>"><?php echo $ads[$rand_ads_num]["link"] ?></a>
    </div>
</body>
